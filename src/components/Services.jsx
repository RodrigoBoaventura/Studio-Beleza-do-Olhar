...
function Services() {
  ...
  return (
    <section id="servicos" className="py-16 bg-gradient-to-br from-pink-50 to-pink-100">
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-gradient-to-br from-pink-400 to-pink-500 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300"
              >
